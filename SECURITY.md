...
- archive creation, parsing, validation, and restore flows
- scan, classification, exclusion, and migration heuristics
- desktop UI interactions and local data handling
